...
| Map Editor | `MapEditorAppIcon.icns` — grid + pads |
| Animation Lab | `AnimLabAppIcon.icns` — film strip + play |
| Asset Upgrader | `AssetUpgraderAppIcon.icns` — low/high texture split |
