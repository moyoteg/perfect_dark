...
def build() -> MapDef:
    ...
    g.add_pad(index=10, x=0.0, y=10, z=500, room=1)  # scenario/case_respawn
    g.add_pad(index=11, x=0.0, y=10, z=-500, room=1)  # scenario/case_respawn
    ...
    g.add_intro(CaseRespawn(team=0, pad=10))
...
def build_tiles_json():
    ...
    return floor_box_with_hill_and_ctf_zones(
        "learn_10_full_arena", half=BOX_HALF, y=0.0,
