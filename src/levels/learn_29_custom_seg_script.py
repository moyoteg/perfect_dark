...
def build() -> MapDef:
    g = MapDef("learn_29_custom_seg_script")
...
def build_tiles_json():
    return floor_box_tiles("learn_29_custom_seg_script", half=BOX_HALF, y=0.0, room_index=1)

import os

SEG_SCRIPT = os.path.join(os.path.dirname(__file__), "..", "..", "scripts", "learn_29_seg_build.py")
