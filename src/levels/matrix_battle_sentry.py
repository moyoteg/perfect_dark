...
# Engine: --laptop-sentry-x4 (4x sentry fire duration) + --unlimited-sentries.
# Deploy: python3 tools/pdmap.py build matrix_battle_sentry --seg --deploy
# Play:   ./scripts/play-matrix-laptop-sentry.sh
# Or:     ./build/pd.arm64 --test-map --moddir mods/mod_allinone --laptop-sentry-x4
...
def build_tiles_json():
    return floor_box_tiles("matrix_battle_sentry", half=BOX_HALF, y=0.0, room_index=1)
