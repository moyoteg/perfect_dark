...
static inline void romdataInitFiles(void)
{
	...
	// Custom pdmap arenas (slots beyond stock ROM file table; load from moddir)
	fileSlots[MOD_NORMAL][FILE_BG_MY_ARENA_SEG].data = 0;
	fileSlots[MOD_NORMAL][FILE_BG_MY_ARENA_SEG].size = 0;
	fileSlots[MOD_NORMAL][FILE_BG_MY_ARENA_SEG].source = SRC_UNLOADED;
	fileSlots[MOD_NORMAL][FILE_BG_MY_ARENA_SEG].preprocessed = 0;
	fileSlots[MOD_NORMAL][FILE_BG_MY_ARENA_SEG].name = "bgdata/bg_my_arena.seg";
	fileSlots[MOD_GEX][FILE_BG_MY_ARENA_SEG] = fileSlots[MOD_NORMAL][FILE_BG_MY_ARENA_SEG];
	fileSlots[MOD_KAKARIKO][FILE_BG_MY_ARENA_SEG] = fileSlots[MOD_NORMAL][FILE_BG_MY_ARENA_SEG];
	fileSlots[MOD_DARKNOON][FILE_BG_MY_ARENA_SEG] = fileSlots[MOD_NORMAL][FILE_BG_MY_ARENA_SEG];
	fileSlots[MOD_GOLDFINGER_64][FILE_BG_MY_ARENA_SEG] = fileSlots[MOD_NORMAL][FILE_BG_MY_ARENA_SEG];

	fileSlots[MOD_NORMAL][FILE_BG_MY_ARENA_TILES].data = 0;
	fileSlots[MOD_NORMAL][FILE_BG_MY_ARENA_TILES].size = 0;
	fileSlots[MOD_NORMAL][FILE_BG_MY_ARENA_TILES].source = SRC_UNLOADED;
	fileSlots[MOD_NORMAL][FILE_BG_MY_ARENA_TILES].preprocessed = 0;
	fileSlots[MOD_NORMAL][FILE_BG_MY_ARENA_TILES].name = "bgdata/bg_my_arena_tilesZ";
	fileSlots[MOD_GEX][FILE_BG_MY_ARENA_TILES] = fileSlots[MOD_NORMAL][FILE_BG_MY_ARENA_TILES];
	fileSlots[MOD_KAKARIKO][FILE_BG_MY_ARENA_TILES] = fileSlots[MOD_NORMAL][FILE_BG_MY_ARENA_TILES];
	fileSlots[MOD_DARKNOON][FILE_BG_MY_ARENA_TILES] = fileSlots[MOD_NORMAL][FILE_BG_MY_ARENA_TILES];
	fileSlots[MOD_GOLDFINGER_64][FILE_BG_MY_ARENA_TILES] = fileSlots[MOD_NORMAL][FILE_BG_MY_ARENA_TILES];

	fileSlots[MOD_NORMAL][FILE_BG_MY_ARENA_PADS].data = 0;
	fileSlots[MOD_NORMAL][FILE_BG_MY_ARENA_PADS].size = 0;
	fileSlots[MOD_NORMAL][FILE_BG_MY_ARENA_PADS].source = SRC_UNLOADED;
	fileSlots[MOD_NORMAL][FILE_BG_MY_ARENA_PADS].preprocessed = 0;
	fileSlots[MOD_NORMAL][FILE_BG_MY_ARENA_PADS].name = "bgdata/bg_my_arena_padsZ";
	fileSlots[MOD_GEX][FILE_BG_MY_ARENA_PADS] = fileSlots[MOD_NORMAL][FILE_BG_MY_ARENA_PADS];
	fileSlots[MOD_KAKARIKO][FILE_BG_MY_ARENA_PADS] = fileSlots[MOD_NORMAL][FILE_BG_MY_ARENA_PADS];
	fileSlots[MOD_DARKNOON][FILE_BG_MY_ARENA_PADS] = fileSlots[MOD_NORMAL][FILE_BG_MY_ARENA_PADS];
	fileSlots[MOD_GOLDFINGER_64][FILE_BG_MY_ARENA_PADS] = fileSlots[MOD_NORMAL][FILE_BG_MY_ARENA_PADS];

	fileSlots[MOD_NORMAL][FILE_USETUPMY_ARENA].data = 0;
	fileSlots[MOD_NORMAL][FILE_USETUPMY_ARENA].size = 0;
	fileSlots[MOD_NORMAL][FILE_USETUPMY_ARENA].source = SRC_UNLOADED;
	fileSlots[MOD_NORMAL][FILE_USETUPMY_ARENA].preprocessed = 0;
	fileSlots[MOD_NORMAL][FILE_USETUPMY_ARENA].name = "Usetupmy_arenaZ";
	fileSlots[MOD_GEX][FILE_USETUPMY_ARENA] = fileSlots[MOD_NORMAL][FILE_USETUPMY_ARENA];
	fileSlots[MOD_KAKARIKO][FILE_USETUPMY_ARENA] = fileSlots[MOD_NORMAL][FILE_USETUPMY_ARENA];
	fileSlots[MOD_DARKNOON][FILE_USETUPMY_ARENA] = fileSlots[MOD_NORMAL][FILE_USETUPMY_ARENA];
	fileSlots[MOD_GOLDFINGER_64][FILE_USETUPMY_ARENA] = fileSlots[MOD_NORMAL][FILE_USETUPMY_ARENA];

	fileSlots[MOD_NORMAL][FILE_UMP_SETUPMY_ARENA].data = 0;
	fileSlots[MOD_NORMAL][FILE_UMP_SETUPMY_ARENA].size = 0;
	fileSlots[MOD_NORMAL][FILE_UMP_SETUPMY_ARENA].source = SRC_UNLOADED;
	fileSlots[MOD_NORMAL][FILE_UMP_SETUPMY_ARENA].preprocessed = 0;
	fileSlots[MOD_NORMAL][FILE_UMP_SETUPMY_ARENA].name = "Ump_setupmy_arenaZ";
	fileSlots[MOD_GEX][FILE_UMP_SETUPMY_ARENA] = fileSlots[MOD_NORMAL][FILE_UMP_SETUPMY_ARENA];
	fileSlots[MOD_KAKARIKO][FILE_UMP_SETUPMY_ARENA] = fileSlots[MOD_NORMAL][FILE_UMP_SETUPMY_ARENA];
	fileSlots[MOD_DARKNOON][FILE_UMP_SETUPMY_ARENA] = fileSlots[MOD_NORMAL][FILE_UMP_SETUPMY_ARENA];
	fileSlots[MOD_GOLDFINGER_64][FILE_UMP_SETUPMY_ARENA] = fileSlots[MOD_NORMAL][FILE_UMP_SETUPMY_ARENA];

	fileSlots[MOD_NORMAL][FILE_BG_TESTARENA_SEG].data = 0;
	fileSlots[MOD_NORMAL][FILE_BG_TESTARENA_SEG].size = 0;
	fileSlots[MOD_NORMAL][FILE_BG_TESTARENA_SEG].source = SRC_UNLOADED;
	fileSlots[MOD_NORMAL][FILE_BG_TESTARENA_SEG].preprocessed = 0;
	fileSlots[MOD_NORMAL][FILE_BG_TESTARENA_SEG].name = "bgdata/bg_testarena.seg";
	fileSlots[MOD_GEX][FILE_BG_TESTARENA_SEG] = fileSlots[MOD_NORMAL][FILE_BG_TESTARENA_SEG];
	fileSlots[MOD_KAKARIKO][FILE_BG_TESTARENA_SEG] = fileSlots[MOD_NORMAL][FILE_BG_TESTARENA_SEG];
	fileSlots[MOD_DARKNOON][FILE_BG_TESTARENA_SEG] = fileSlots[MOD_NORMAL][FILE_BG_TESTARENA_SEG];
	fileSlots[MOD_GOLDFINGER_64][FILE_BG_TESTARENA_SEG] = fileSlots[MOD_NORMAL][FILE_BG_TESTARENA_SEG];

	fileSlots[MOD_NORMAL][FILE_BG_TESTARENA_TILES].data = 0;
	fileSlots[MOD_NORMAL][FILE_BG_TESTARENA_TILES].size = 0;
	fileSlots[MOD_NORMAL][FILE_BG_TESTARENA_TILES].source = SRC_UNLOADED;
	fileSlots[MOD_NORMAL][FILE_BG_TESTARENA_TILES].preprocessed = 0;
	fileSlots[MOD_NORMAL][FILE_BG_TESTARENA_TILES].name = "bgdata/bg_testarena_tilesZ";
	fileSlots[MOD_GEX][FILE_BG_TESTARENA_TILES] = fileSlots[MOD_NORMAL][FILE_BG_TESTARENA_TILES];
	fileSlots[MOD_KAKARIKO][FILE_BG_TESTARENA_TILES] = fileSlots[MOD_NORMAL][FILE_BG_TESTARENA_TILES];
	fileSlots[MOD_DARKNOON][FILE_BG_TESTARENA_TILES] = fileSlots[MOD_NORMAL][FILE_BG_TESTARENA_TILES];
	fileSlots[MOD_GOLDFINGER_64][FILE_BG_TESTARENA_TILES] = fileSlots[MOD_NORMAL][FILE_BG_TESTARENA_TILES];

	fileSlots[MOD_NORMAL][FILE_BG_TESTARENA_PADS].data = 0;
	fileSlots[MOD_NORMAL][FILE_BG_TESTARENA_PADS].size = 0;
	fileSlots[MOD_NORMAL][FILE_BG_TESTARENA_PADS].source = SRC_UNLOADED;
	fileSlots[MOD_NORMAL][FILE_BG_TESTARENA_PADS].preprocessed = 0;
	fileSlots[MOD_NORMAL][FILE_BG_TESTARENA_PADS].name = "bgdata/bg_testarena_padsZ";
	fileSlots[MOD_GEX][FILE_BG_TESTARENA_PADS] = fileSlots[MOD_NORMAL][FILE_BG_TESTARENA_PADS];
	fileSlots[MOD_KAKARIKO][FILE_BG_TESTARENA_PADS] = fileSlots[MOD_NORMAL][FILE_BG_TESTARENA_PADS];
	fileSlots[MOD_DARKNOON][FILE_BG_TESTARENA_PADS] = fileSlots[MOD_NORMAL][FILE_BG_TESTARENA_PADS];
	fileSlots[MOD_GOLDFINGER_64][FILE_BG_TESTARENA_PADS] = fileSlots[MOD_NORMAL][FILE_BG_TESTARENA_PADS];

	fileSlots[MOD_NORMAL][FILE_USETUPTESTARENA].data = 0;
	fileSlots[MOD_NORMAL][FILE_USETUPTESTARENA].size = 0;
	fileSlots[MOD_NORMAL][FILE_USETUPTESTARENA].source = SRC_UNLOADED;
	fileSlots[MOD_NORMAL][FILE_USETUPTESTARENA].preprocessed = 0;
	fileSlots[MOD_NORMAL][FILE_USETUPTESTARENA].name = "UsetuptestarenaZ";
	fileSlots[MOD_GEX][FILE_USETUPTESTARENA] = fileSlots[MOD_NORMAL][FILE_USETUPTESTARENA];
	fileSlots[MOD_KAKARIKO][FILE_USETUPTESTARENA] = fileSlots[MOD_NORMAL][FILE_USETUPTESTARENA];
	fileSlots[MOD_DARKNOON][FILE_USETUPTESTARENA] = fileSlots[MOD_NORMAL][FILE_USETUPTESTARENA];
	fileSlots[MOD_GOLDFINGER_64][FILE_USETUPTESTARENA] = fileSlots[MOD_NORMAL][FILE_USETUPTESTARENA];

	fileSlots[MOD_NORMAL][FILE_UMP_SETUPTESTARENA].data = 0;
	fileSlots[MOD_NORMAL][FILE_UMP_SETUPTESTARENA].size = 0;
	fileSlots[MOD_NORMAL][FILE_UMP_SETUPTESTARENA].source = SRC_UNLOADED;
	fileSlots[MOD_NORMAL][FILE_UMP_SETUPTESTARENA].preprocessed = 0;
	fileSlots[MOD_NORMAL][FILE_UMP_SETUPTESTARENA].name = "Ump_setuptestarenaZ";
	fileSlots[MOD_GEX][FILE_UMP_SETUPTESTARENA] = fileSlots[MOD_NORMAL][FILE_UMP_SETUPTESTARENA];
	fileSlots[MOD_KAKARIKO][FILE_UMP_SETUPTESTARENA] = fileSlots[MOD_NORMAL][FILE_UMP_SETUPTESTARENA];
	fileSlots[MOD_DARKNOON][FILE_UMP_SETUPTESTARENA] = fileSlots[MOD_NORMAL][FILE_UMP_SETUPTESTARENA];
	fileSlots[MOD_GOLDFINGER_64][FILE_UMP_SETUPTESTARENA] = fileSlots[MOD_NORMAL][FILE_UMP_SETUPTESTARENA];

	// Animation Lab (STAGE_ANIMLAB 0x82) — mod-only pdmap arena slots
	fileSlots[MOD_NORMAL][FILE_BG_ANIMLAB_SEG].data = 0;
	fileSlots[MOD_NORMAL][FILE_BG_ANIMLAB_SEG].size = 0;
	fileSlots[MOD_NORMAL][FILE_BG_ANIMLAB_SEG].source = SRC_UNLOADED;
	fileSlots[MOD_NORMAL][FILE_BG_ANIMLAB_SEG].preprocessed = 0;
	fileSlots[MOD_NORMAL][FILE_BG_ANIMLAB_SEG].name = "bgdata/bg_animlab.seg";
	fileSlots[MOD_GEX][FILE_BG_ANIMLAB_SEG] = fileSlots[MOD_NORMAL][FILE_BG_ANIMLAB_SEG];
	fileSlots[MOD_KAKARIKO][FILE_BG_ANIMLAB_SEG] = fileSlots[MOD_NORMAL][FILE_BG_ANIMLAB_SEG];
	fileSlots[MOD_DARKNOON][FILE_BG_ANIMLAB_SEG] = fileSlots[MOD_NORMAL][FILE_BG_ANIMLAB_SEG];
	fileSlots[MOD_GOLDFINGER_64][FILE_BG_ANIMLAB_SEG] = fileSlots[MOD_NORMAL][FILE_BG_ANIMLAB_SEG];

	fileSlots[MOD_NORMAL][FILE_BG_ANIMLAB_TILES].data = 0;
	fileSlots[MOD_NORMAL][FILE_BG_ANIMLAB_TILES].size = 0;
	fileSlots[MOD_NORMAL][FILE_BG_ANIMLAB_TILES].source = SRC_UNLOADED;
	fileSlots[MOD_NORMAL][FILE_BG_ANIMLAB_TILES].preprocessed = 0;
	fileSlots[MOD_NORMAL][FILE_BG_ANIMLAB_TILES].name = "bgdata/bg_animlab_tilesZ";
	fileSlots[MOD_GEX][FILE_BG_ANIMLAB_TILES] = fileSlots[MOD_NORMAL][FILE_BG_ANIMLAB_TILES];
	fileSlots[MOD_KAKARIKO][FILE_BG_ANIMLAB_TILES] = fileSlots[MOD_NORMAL][FILE_BG_ANIMLAB_TILES];
	fileSlots[MOD_DARKNOON][FILE_BG_ANIMLAB_TILES] = fileSlots[MOD_NORMAL][FILE_BG_ANIMLAB_TILES];
	fileSlots[MOD_GOLDFINGER_64][FILE_BG_ANIMLAB_TILES] = fileSlots[MOD_NORMAL][FILE_BG_ANIMLAB_TILES];

	fileSlots[MOD_NORMAL][FILE_BG_ANIMLAB_PADS].data = 0;
	fileSlots[MOD_NORMAL][FILE_BG_ANIMLAB_PADS].size = 0;
	fileSlots[MOD_NORMAL][FILE_BG_ANIMLAB_PADS].source = SRC_UNLOADED;
	fileSlots[MOD_NORMAL][FILE_BG_ANIMLAB_PADS].preprocessed = 0;
	fileSlots[MOD_NORMAL][FILE_BG_ANIMLAB_PADS].name = "bgdata/bg_animlab_padsZ";
	fileSlots[MOD_GEX][FILE_BG_ANIMLAB_PADS] = fileSlots[MOD_NORMAL][FILE_BG_ANIMLAB_PADS];
	fileSlots[MOD_KAKARIKO][FILE_BG_ANIMLAB_PADS] = fileSlots[MOD_NORMAL][FILE_BG_ANIMLAB_PADS];
	fileSlots[MOD_DARKNOON][FILE_BG_ANIMLAB_PADS] = fileSlots[MOD_NORMAL][FILE_BG_ANIMLAB_PADS];
	fileSlots[MOD_GOLDFINGER_64][FILE_BG_ANIMLAB_PADS] = fileSlots[MOD_NORMAL][FILE_BG_ANIMLAB_PADS];

	fileSlots[MOD_NORMAL][FILE_USETUPANIMLAB].data = 0;
	fileSlots[MOD_NORMAL][FILE_USETUPANIMLAB].size = 0;
	fileSlots[MOD_NORMAL][FILE_USETUPANIMLAB].source = SRC_UNLOADED;
	fileSlots[MOD_NORMAL][FILE_USETUPANIMLAB].preprocessed = 0;
	fileSlots[MOD_NORMAL][FILE_USETUPANIMLAB].name = "UsetupanimlabZ";
	fileSlots[MOD_GEX][FILE_USETUPANIMLAB] = fileSlots[MOD_NORMAL][FILE_USETUPANIMLAB];
	fileSlots[MOD_KAKARIKO][FILE_USETUPANIMLAB] = fileSlots[MOD_NORMAL][FILE_USETUPANIMLAB];
	fileSlots[MOD_DARKNOON][FILE_USETUPANIMLAB] = fileSlots[MOD_NORMAL][FILE_USETUPANIMLAB];
	fileSlots[MOD_GOLDFINGER_64][FILE_USETUPANIMLAB] = fileSlots[MOD_NORMAL][FILE_USETUPANIMLAB];

	fileSlots[MOD_NORMAL][FILE_UMP_SETUPANIMLAB].data = 0;
	fileSlots[MOD_NORMAL][FILE_UMP_SETUPANIMLAB].size = 0;
	fileSlots[MOD_NORMAL][FILE_UMP_SETUPANIMLAB].source = SRC_UNLOADED;
	fileSlots[MOD_NORMAL][FILE_UMP_SETUPANIMLAB].preprocessed = 0;
	fileSlots[MOD_NORMAL][FILE_UMP_SETUPANIMLAB].name = "Ump_setupanimlabZ";
	fileSlots[MOD_GEX][FILE_UMP_SETUPANIMLAB] = fileSlots[MOD_NORMAL][FILE_UMP_SETUPANIMLAB];
	fileSlots[MOD_KAKARIKO][FILE_UMP_SETUPANIMLAB] = fileSlots[MOD_NORMAL][FILE_UMP_SETUPANIMLAB];
	fileSlots[MOD_DARKNOON][FILE_UMP_SETUPANIMLAB] = fileSlots[MOD_NORMAL][FILE_UMP_SETUPANIMLAB];
	fileSlots[MOD_GOLDFINGER_64][FILE_UMP_SETUPANIMLAB] = fileSlots[MOD_NORMAL][FILE_UMP_SETUPANIMLAB];
}
